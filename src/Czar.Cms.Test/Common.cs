...
namespace Czar.Cms.Test
{
    public class Common
    {
        ...
        public static IServiceProvider BuildServiceForSqlServer()
        {
            ...
            {
                options.ConnectionString = "Data Source=.;Initial Catalog=CzarCms;User ID=sa;Password=db2017;Persist Security Info=True;Max Pool Size=50;Min Pool Size=0;Connection Lifetime=300;";
